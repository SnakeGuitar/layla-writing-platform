...
/// <summary>
/// Stateless validation primitives reused across schemas.
/// Mirrors <c>Layla.Desktop.Services.Validation.ValidationService</c> so both
/// clients enforce the same rules client-side before hitting the API.
/// </summary>
